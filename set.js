...
global.caption = "*©𝟐𝟎𝟐𝟒 Amir MD*"; // Input Yours custom...(Maintain font for Flow)
...
global.footer = "*We are Anonymous*"; // Input Yours custom...(Maintain font for Flow)
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254715264486", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "AMIR ZAID", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "AMIR", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "MD💜", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "AMIR-𝐌𝐃", // Input Yours custom...(Maintain font for Flow)
BOT_PIC: process.env.BOT_PIC || "https://files.giftedtech.my.id/file/gifted-md.jpg", // You can Replace with yours...
AUTO_AUDIO: process.env.AUTO_AUDIO || "false",
AUTO_BIO: process.env.AUTO_BIO || "false",
AUTO_BIO_QUOTE: process.env.AUTO_BIO_QUOTE || "Amir creates things that creates other things",
